...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Добро пожаловать в приложение калькулятор\nКалькулятор работает с арабскими и римскими числами\n" +
                "Арабские числа и результат их вычислений и должны укладываться в диапазон -2,147,483,648 до 2,147,483,647\n" +
                "Римские числа и результат их вычислений и должны быть больше нуля и не более MMM (3,000)");
